...
# TODO try to get back old script from git - maybe pdb_discarding was the issue. 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_jobs', type=int, default=10, help='Number of parallel jobs to submit per stage.')
